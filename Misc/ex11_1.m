...
%     x_tdoa,rho,C,x_init,epsilon,max_num_iterations,force_full_calc,plot_progress,ref_idx
    % Compute solutions
    [~,x_ls_local] = tdoa.lsSoln(x_sensor,rho(:,idx),Croa,x_init,epsilon,numIters,true,false,[]);
