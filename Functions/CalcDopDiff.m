function ddop = CalcDopDiff(x0,v0,x1,v1,x2,v2,f)
...
%
% OUTPUTS:
%   ddop    Different Doppler shift 

% Abeer Nasir Chaudhry
% Oct 2024

% Compute Doppler velocity from reference to each set of test positions
dop1 = calculateDoppler(x0,v0,x1,v1,f); % N x M
dop2 = calculateDoppler(x0,v0,x2,v2,f); % N x M
